...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/mingw --enable-gpl --enable-nonfree --enable-postproc --enable-avfilter --enable-w32threads --enable-runtime-cpudetect --enable-memalign-hack --enable-bzlib --enable-libfaac --enable-libgsm --enable-libmp3lame --enable-libspeex --enable-libtheora --enable-libvorbis --enable-libx264 --enable-libxvid --enable-zlib --disable-debug --extra-cflags=-I/local/include --extra-ldflags=-L/local/lib
prefix=/mingw
...
CFLAGS=  -I/local/include -std=c99 -fomit-frame-pointer -Id:/mingw/include -Id:/mingw/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I/local/include
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/local/lib  -Wl,--nxcompat -Wl,--dynamicbase -Wl,--large-address-aware -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
...
EXTRALIBS=-lavicap32 -lgdi32 -lws2_32 -liconv -lxvidcore -Ld:/mingw/lib -lx264 -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -Ld:/mingw/lib -lspeex -lmp3lame -lgsm -lfaac -lm -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
